    ...
    <div className="auth-root">
        ...
        <div className="geo-bg">
          <svg className="geo-svg" viewBox="0 0 600 700" fill="none">
            ...
            {[0.4, 0.7, 0.55, 0.85, 0.6, 0.9, 0.5].map((h, i) => (
              <rect key={i} x={148 + i * 48} y={520 - h * 80} width="28" height={h * 80} rx="4"
                fill="#00d4a4" fillOpacity={0.08 + h * 0.15} stroke="#00d4a4" strokeOpacity="0.3" strokeWidth="1"/>
            ))}
          </svg>
        </div>
        <div className="panel-left-content">
          <div className="brand-mark"><span className="brand-icon">RT</span></div>
          <h1 className="panel-title">Join the<br/>Platform</h1>
          <p className="panel-sub">Start tracking reviews, sessions and<br/>intern progress in one place.</p>
      ...
      <div className="auth-panel-right">
        ...
        <div className="mobile-brand">
          <span className="brand-icon-mob">RT</span>
        ...
        <div className="auth-form-wrap">
          {success ? (
            <div className="success-box">
              ...
              <p className="success-msg">We sent a confirmation link to <strong>{form.email}</strong>. Click it to activate your account, then sign in.</p>
              <Link href="/auth/login" className="auth-btn-link">Go to Sign In →</Link>
            </div>
          ) : (
            <>
              <div className="auth-form-head">
                <h2 className="form-title">Create account</h2>
                <p className="form-sub">Set up your reviewer profile</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="auth-form">
                <div className="field">
                  ...
                  <div className="field-wrap">
                    <svg className="field-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6">
                      ...
                      <path strokeLinecap="round" d="M3 17c0-3.3 3.1-6 7-6s7 2.7 7 6"/>
                    </svg>
                    <input type="text" required value={form.fullName} onChange={set('fullName')} placeholder="Dr. Alex Kim" className="field-input"/>
                  </div>
                </div>
                ...
                <div className="field">
                  ...
                  <div className="field-wrap">
                    ...
                    <input type="email" required value={form.email} onChange={set('email')} placeholder="you@example.com" className="field-input"/>
                  </div>
                </div>
                ...
                <div className="field-row">
                  <div className="field">
                    ...
                    <div className="field-wrap">
                      ...
                      <input type={showPw ? 'text' : 'password'} required minLength={6} value={form.password} onChange={set('password')} placeholder="Min. 6 chars" className="field-input field-input-pw"/>
                  ...
                  <div className="field">
                    ...
                    <div className="field-wrap">
                      ...
                      <input type={showPw ? 'text' : 'password'} required value={form.confirm} onChange={set('confirm')} placeholder="Re-enter" className="field-input"/>
                    </div>
                  </div>
                </div>
              ...
              <p className="auth-switch">Already have an account?{' '}<Link href="/auth/login" className="auth-link">Sign in →</Link></p>
            </>
          )}
        </div>
      </div>
      ...
      <style suppressHydrationWarning>{`
        ...
        *{box-sizing:border-box;}
        ...
        .brand-icon-mob{display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;background:#00d4a4;border-radius:9px;font-family:'Syne',sans-serif;font-weight:800;font-size:12px;color:#070d1a;}
        ...
        .form-title{font-family:'Syne',sans-serif;font-size:1.85rem;font-weight:800;color:#fff;margin:0 0 .35rem;}
        @media(max-width:400px){.form-title{font-size:1.55rem;}}
        .form-sub{font-size:.87rem;color:#4a6a7a;margin:0;}
        ...
        .field-label{font-size:.68rem;font-weight:600;text-transform:uppercase;letter-spacing:.1em;color:#4a6a7a;}
        .field-wrap{position:relative;display:flex;align-items:center;}
        .field-icon{position:absolute;left:13px;width:15px;height:15px;color:#4a6a7a;pointer-events:none;}
        .field-input{width:100%;background:#0e1e2e;border:1.5px solid #1a3040;border-radius:11px;padding:.75rem 1rem .75rem 2.6rem;font-size:.87rem;color:#e0f0ff;font-family:'Instrument Sans',sans-serif;outline:none;transition:border-color .2s,box-shadow .2s;}
        ...
        .pw-toggle{position:absolute;right:12px;background:none;border:none;cursor:pointer;font-size:.82rem;color:#4a6a7a;padding:2px;}

        .auth-error{background:rgba(239,68,68,.08);border:1px solid rgba(239,68,68,.25);border-radius:10px;padding:.65rem 1rem;font-size:.82rem;color:#f87171;}
        .auth-btn{width:100%;padding:.88rem;background:#00d4a4;border:none;border-radius:12px;font-family:'Syne',sans-serif;font-weight:700;font-size:.92rem;color:#070d1a;cursor:pointer;transition:background .2s,transform .1s;display:flex;align-items:center;justify-content:center;}
        ...
        .auth-switch{text-align:center;font-size:.83rem;color:#4a6a7a;margin:0;}
        .auth-link{color:#00d4a4;font-weight:600;text-decoration:none;}
        .auth-link:hover{text-decoration:underline;}

        .success-box{text-align:center;padding:1.5rem 0;}
        .success-icon{width:54px;height:54px;background:rgba(0,212,164,.1);border:2px solid #00d4a4;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:1.3rem;color:#00d4a4;margin:0 auto 1.1rem;}
        .success-title{font-family:'Syne',sans-serif;font-size:1.45rem;font-weight:800;color:#fff;margin:0 0 .55rem;}
        .success-msg{font-size:.88rem;color:#4a6a7a;line-height:1.6;margin:0 0 1.4rem;}
        .success-msg strong{color:#e0f0ff;}
        .auth-btn-link{display:inline-block;padding:.82rem 2rem;background:#00d4a4;border-radius:12px;font-family:'Syne',sans-serif;font-weight:700;color:#070d1a;text-decoration:none;transition:background .2s;}
        .auth-btn-link:hover{background:#00efb8;}
      `}</style>
    </div>
  );
}